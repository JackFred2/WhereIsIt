 ...
 */
public record EnchantmentCriterion(Enchantment enchantment, @Nullable Integer targetLevel) implements Criterion {
    public static final MapCodec<EnchantmentCriterion> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            BuiltInRegistries.ENCHANTMENT.byNameCodec().fieldOf("enchantment").forGetter(EnchantmentCriterion::enchantment),
    ...
    private EnchantmentCriterion(Enchantment enchantment, Optional<Integer> targetLevel) {
